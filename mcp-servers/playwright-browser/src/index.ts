...
async function createBrowserSession(headless: boolean = false): Promise<BrowserSession> {
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  ...
  try {
    switch (name) {
      ...
      case 'close_browser': {
        const sessionId = (args as any).sessionId || currentSessionId;
